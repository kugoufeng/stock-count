 ...
 */
public class ContinuousLimitStockCount extends BaseStockCount
{
    ...
    static class ContinuousLimitStockReducer extends Reducer<Text, RawStock, Text, DemonStock>
    {
        @Override
        ...
        throws IOException, ClassNotFoundException, InterruptedException
    {
        ...
        String date = args[2];
        BaseStockCount stockCount = new ContinuousLimitStockCount();
        stockCount.setCountDate(date);

        JobStartFiled jobStartFiled =
            new JobStartFiled(ContinuousLimitStockCount.class,
                RawStockMapper.class,
                ContinuousLimitStockReducer.class,
                Text.class,
                RawStock.class,
                Text.class,
                DemonStock.class,
